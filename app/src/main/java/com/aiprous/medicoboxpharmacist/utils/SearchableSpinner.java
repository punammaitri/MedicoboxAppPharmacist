...
public class SearchableSpinner extends Spinner implements View.OnTouchListener,
    ...
    private void init() {
        ...
        if (_searchableListDialog == null)
            _searchableListDialog = SearchableListDialog.getInstance(_items);
        _searchableListDialog.setOnSearchableItemClickListener(this);
        setOnTouchListener(this);

        _arrayAdapter = (ArrayAdapter) getAdapter();
        if (!TextUtils.isEmpty(_strHintText)) {
            ArrayAdapter arrayAdapter = new ArrayAdapter(_context, R.layout.spinner_textview_medium, new String[]{_strHintText});
            _isFromInit = true;
