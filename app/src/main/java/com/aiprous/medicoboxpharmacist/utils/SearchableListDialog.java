...
public class SearchableListDialog extends DialogFragment implements
    ...
    public static SearchableListDialog getInstance(List items) {
...
//        dismiss();
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        if (dialogShown) {
            ...
            String strPositiveButton = _strPositiveButtonText == null ? getActivity().getResources().getString(R.string.txt_close) : _strPositiveButtonText;
...
//        items.add(0, "");
        ...
        listAdapter = new ArrayAdapter(getActivity(), R.layout.spinner_textview_medium, items);
